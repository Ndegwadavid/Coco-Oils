        ...
        <div className="prose prose-lg max-w-none">
          <div className="bg-primary/10 p-6 rounded-xl mb-8">
            ...
            <p className="text-lg leading-relaxed">
              Made in the 100% organic way from fresh coconuts in Watamu. No preservatives, no chemical additives, no
          ...
          <div className="grid gap-6 my-8">
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  We carefully select and harvest only the freshest, ripest coconuts from sustainable farms in Watamu,
                  Kenya. Our coconuts are grown without the use of pesticides or harmful chemicals.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  We use a traditional cold-pressing method to extract the oil from fresh coconut meat. This gentle
                  process ensures that all the natural nutrients, enzymes, and beneficial compounds remain intact.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Our oil is filtered naturally without the use of chemicals or bleaching agents. This minimal
                  processing preserves the oil&apos;s natural aroma, flavor, and nutritional properties.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  We package our coconut oil in environmentally friendly containers that protect the oil from light and
                  air, ensuring maximum freshness and shelf life without the need for preservatives.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-muted rounded-xl p-6 my-8">
            ...
            <p className="mb-4">
              Our commitment to purity and quality means you get coconut oil exactly as nature intended. Try our
              products today and feel the difference that truly organic coconut oil can make.
            </p>
            <Button asChild>
              <Link href="/shop">
